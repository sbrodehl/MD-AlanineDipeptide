...
echo "13\n" | gmx genion -o ionized.gro -s iongen.tpr -p topol.top -conc 0.25 || exit 1
...
gmx mdrun -nt 1 -deffnm npt -v || exit 1
...
gmx rama -o 10ns_temp300conc025.xvg -f md.trr -s md.tpr || exit 1
